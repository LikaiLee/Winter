...
public class GetRequestHandler implements RequestHandler {
    ...
    public FullHttpResponse handle(FullHttpRequest fullHttpRequest) throws Exception {
        ...
        RouteDefinition routeDefinition = RouteMethodMapper.getMethodDefinition(requestPath, RequestMethod.GET);
        // 解析 URL 中的参数
        ...
        LOGGER.info("GET request on method [{}#{}] with uri {}", dispatchMethod.getDeclaringClass().getSimpleName(), dispatchMethod.getName(), requestUri);
        // 解析 Body 参数
        ...
        // 调用 URL 对应的方法
        String beanName = WinterUtils.getBeanName(dispatchMethod.getDeclaringClass());
